...
<head>
	...
	<!-- Meta tag Keywords -->
	<!-- css file -->
	<link rel="stylesheet" href="{{ asset('backend2/css/style.css') }}" type="text/css" media="all" />
	<!-- Style-CSS -->
	<!-- //css file -->
	<!-- web-fonts -->
...
<body>
	...
	<!-- Jquery -->
	<script src="{{ asset('backend2/js/jquery-2.2.3.min.js') }}"></script>
	<!-- //Jquery -->
	<!-- Jquery -->
	<script src="{{ asset('backend2/js/jquery-simple-validator.min.js') }}"></script>
	<!-- //Jquery -->
